Конечно! Вот обновлённая версия вашего документа с добавлением ссылок на три диаграммы вариантов использования (Use Case Diagram 1, 2, 3) в соответствующем разделе.

...
\<a name="select\_level"/\>

## 2.2 Выбрать уровень

**Описание.** Вариант использования "Выбрать уровень" позволяет пользователю задать сложность предстоящей тренировки.  
